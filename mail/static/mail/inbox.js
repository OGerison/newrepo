document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('#compose-form').onsubmit = () => {
        ...
        const attachment = document.querySelector('#compose-attachment').value;
        ...
        fetch('/emails', {
            method: 'POST',
            body: JSON.stringify({recipients, subject, body,attachment})
        })
            .then(response =>{
                console.log("Attachment url....",attachment)
                response.json()
...
function compose_email(event, recipients = '', subject = '', body = '', attachment = '') {
    ...
    document.querySelector('#compose-attachment').value = attachment;
...
function loadEmail(emailData, fromMailbox) {
    ...
    detailedInfo.innerHTML = `
        ...
        <div>
            <span class="text-muted">Attachment: </span>${emailData.attachment}
        </div>
    `
    ...
    attachmentLine.innerHTML = `<span class="text-muted">Attachment: </span>${emailData.attachment}`;
    ...
    bodySection.innerText = emailData.attachment;
    ...
    replyButton.addEventListener('click', function(event) {
        ...
        compose_email(event, recipient, subject, body,attachment)
    });
